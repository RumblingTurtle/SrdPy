...
iiwaLinks = getLinkArrayFromURDF(os.path.abspath(os.path.dirname(sys.argv[0])+"/iiwa14.urdf"),True)
...
chainLinks = getLinkArrayFromURDF(os.path.abspath(os.path.dirname(sys.argv[0])+"/iiwa14.urdf"),True)
